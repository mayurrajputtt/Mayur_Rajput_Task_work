...
try:
    ...
    import urllib.error
    requests = None  # Fallback to urllib if requests is missing
...
class BinanceAPIError(Exception):
    """Exception raised for Binance API returned errors."""
...
class NetworkError(Exception):
    """Exception raised for connection and network timeouts."""

    pass


class BinanceTestnetClient:
    """Wrapper for Binance USDT-M Futures Testnet REST API."""
    ...
    def send_request(
        ...
        """Executes HTTP request to Binance USDT-M Futures Testnet."""
        if params is None:
            params = {}
